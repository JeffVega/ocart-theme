...
<section class="relative bg-navy pt-36 pb-20 overflow-hidden">
  <div class="absolute inset-0 bg-[radial-gradient(ellipse_60%_70%_at_85%_20%,_#162852_0%,_transparent_60%)]"></div>
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
    <div class="text-gold text-[11px] uppercase tracking-[0.2em] font-bold mb-4">Get Help Now</div>
    <h1 class="font-display text-6xl lg:text-8xl text-cream font-bold leading-none mb-6">
      Contact<br/><span class="text-gold italic">Us</span>
    </h1>
    <p class="text-cream/60 text-lg max-w-lg leading-relaxed">
      24 hours a day, 7 days a week. If you've been arrested, don't wait.
    </p>
  </div>
</section>
